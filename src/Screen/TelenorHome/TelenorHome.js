    ...
    return (
        <View style={styles.container}>
            <CustomPkgBtn
                ...
                onPress={() => {
                    moveToScreen(NavigationStrings.TELENOR_CALL);
                }}
            />
            <CustomPkgBtn
                btnText={'SMS Offers'}
                ...
                iconStyle={styles.iconStyle}
                onPress={() => {
                    moveToScreen(NavigationStrings.TELENOR_MSG);
                }}
            ...
            <CustomPkgBtn
                ...
                iconStyle={styles.iconStyle}
                onPress={() => {
                    moveToScreen(NavigationStrings.TELENOR_INTERNET);
                }}
            ...
            {/* <CustomPkgBtn
                ...
                iconStyle={styles.iconStyle}
                onPress={() => {
                    moveToScreen(NavigationStrings.TELENOR_LOCATION);
                }}
            /> */}
            {/* <CustomPkgBtn
