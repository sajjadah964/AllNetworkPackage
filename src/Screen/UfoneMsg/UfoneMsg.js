                ...
                <View style={{ padding: 8, borderRadius: 12, backgroundColor: '#fff' }}>
                    ...
                    <View style={{ flex: 1, flexDirection: 'row', marginBottom: 20 }}>
                        ...
                        {item.pkgDetails.onnetMint ?
                            <View style={{
                                ...
                                <Text style={{ ...styles.pkgDetailsStyle, backgroundColor: '#ff6501' }}>{item.pkgDetails.onnetMint}</Text>
                        ...
                        {item.pkgDetails.offnetMint ?
                            <View style={{ flex: 1 }}>
                                ...
                                <Text style={{ ...styles.pkgDetailsStyle, backgroundColor: '#ff6501' }}>{item.pkgDetails.offnetMint}</Text>
                        ...
                        {item.pkgDetails.sms ?
                            <View style={{ flex: 1 }}>
                                ...
                                <Text style={{ ...styles.pkgDetailsStyle, backgroundColor: '#ff6501' }}>{item.pkgDetails.sms}</Text>
                        ...
                        {item.pkgDetails.internet ?
                            <View style={{ flex: 1 }}>
                                ...
                                <Text style={{ ...styles.pkgDetailsStyle, backgroundColor: '#ff6501' }}>{item.pkgDetails.internet}</Text>
                    ...
                    >
                        <TouchableOpacity
                            ...
                            activeOpacity={0.8}
                            style={{ ...styles.subscribeBtn, backgroundColor: '#ff6501' }}
                        >
